<template>
    <div class="container">
        ...
        <div class="container">
          <div class="icons">
            <i class="fas fa-moon" @click="toggleDarkMode"></i>
            <i class="fas fa-sun" @click="toggleDarkMode"></i>
          </div>
          <div class="time">
            <div class="time-colon">
              <div class="time-text">
                <span class="num hour_num">{{ hour }}</span>
            ...
            <div class="time-colon">
              <div class="time-text">
                <span class="num min_num">{{ minute }}</span>
            ...
            <div class="time-colon">
              <div class="time-text">
                <span class="num sec_num">{{ second }}</span>
                <span class="text">Seconds</span>
              </div>
              <span class="am_pm">{{ period }}</span>
            </div>
          </div>
        </div>
                    </section>
